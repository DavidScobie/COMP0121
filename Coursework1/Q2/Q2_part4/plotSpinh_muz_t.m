function objHandle = plotSpinh_muz_t(figHandle,vecMu,deltaT,colors)
...
objHandle(1)=plot(figHandle, [deltaT deltaT], [0 vecMu(3)],...
      'Color',colors(1), 'Linestyle', '-', 'LineWidth', 2);
%Plotting the points at the end of the spin vectors.
objHandle(2)=plot(figHandle,deltaT,vecMu(3),...
